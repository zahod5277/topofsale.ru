{$_modx->runSnippet('!mFilter2',[
    ...
    'aliases' => 'ms|price:number==price,ms|vendor==vendor,ms|made_in==country,ms|sex==gender,ms|complication==complication,ms|forma==format,ms|stat==status,ms|body_material==material,ms|strap_type==strap_type,ms|dial_color==dial_color,ms|body_diameter==diameter,ms|clockwork==clockwork,ms|strap_color==strap_color',
